...
namespace TrainingAPI.Migrations
{
    ...
    [Migration("20230831105331_changeNullableToFalse")]
            ...
            modelBuilder.Entity("TrainingAPI.Models.DTO.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedTime = new DateTime(2023, 8, 31, 13, 53, 31, 454, DateTimeKind.Local).AddTicks(1193),
                            Details = "Nice villa",
                            ...
                            Rate = 5.0,
                            Sqft = 100,
                            UpdatedTime = new DateTime(2023, 8, 31, 13, 53, 31, 454, DateTimeKind.Local).AddTicks(1234)
                        },
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedTime = new DateTime(2023, 8, 31, 13, 53, 31, 454, DateTimeKind.Local).AddTicks(1238),
                            ...
                            Rate = 5.0,
                            Sqft = 120,
                            UpdatedTime = new DateTime(2023, 8, 31, 13, 53, 31, 454, DateTimeKind.Local).AddTicks(1239)
                        });
                });
